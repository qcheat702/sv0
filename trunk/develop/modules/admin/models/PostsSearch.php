...
use sv\admin\models\Posts;

/**
 * PostsSearch represents the model behind the search form about `sv\admin\models\Posts`.
 */
class PostsSearch extends Posts
{
    ...
    public function rules()
    {
        return [
            ...
            [['post_content', 'post_title', 'post_excerpt', 'post_status', 'comment_status', 'ping_status', 'post_password', 'post_name', 'to_ping', 'pinged', 'post_content_filtered', 'guid', 'post_type'], 'safe'],
        ];
    }
