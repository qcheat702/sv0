...
/**
 * UsersSearch represents the model behind the search form about `sv\admin\models\Users`.
 */
class UsersSearch extends Users
{
    ...
    {
        return [
            [['ID', 'user_registered', 'user_status'], 'integer'],
            [['user_login', 'user_pass', 'user_nicename', 'user_email', 'user_url', 'user_activation_key', 'display_name'], 'safe'],
        ];
    }
